...
@section('content_header')
    <h1 class="font-weight-bold">REQUISITOS</h1>
@stop
...
@section('content')
    <div class="card">
        ...
        <div class="card-header">
            <a href="{{ route('admin.requirements.create') }}" class="btn btn-primary font-weight-bold text-uppercase">Registrar nuevo</a>
        </div>
                    ...
                    "render": function(data, type, row, meta) {
                        return (
                            `<div class="d-flex flex-row justify-content-end">
                                <a class="btn btn-primary btn-sm mr-2 font-weight-bold text-uppercase btn-edit" href="{{ route('admin.requirements.edit', ':id') }}"><i class="far fa-edit"></i> Editar</a>
