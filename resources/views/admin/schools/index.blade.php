...
@section('content')
    <div class="card">
        ...
        <div class="card-header">
            <a href="{{ route('admin.schools.create') }}" class="btn btn-primary">Registrar nueva escuela</a>
        </div>
                    ...
                    "render": function(data, type, row, meta) {
                        return (
                            `<div class="d-flex flex-row justify-content-start">
                                <a class="btn btn-primary btn-sm mr-2 btn-edit" href="{{ route('admin.schools.edit', ':id') }}"><i class="far fa-edit"></i> Editar</a>
